...
difei = Partner("Lu", "Difei", "ldfghh")
jiawei = Partner("Zhang", "Jiawei", "jz34")
team = [difei, jiawei]

problem1 = Problem("Sudoku", 'common',"sudoku")
problem2 = Problem("Pentominoes", 'common',"Pentominoes")
 # In this case, the Python file for the formulation would be named End_Poverty.py.

problems = [problem1, problem2]

our_submission = Who_and_what([difei, jiawei], OPTION_C2PLUS, problems)
